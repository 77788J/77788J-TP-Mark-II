...
namespace auton_selector {
  ...
  // callbacks
  lv_res_t btn_click_action_red_flag(lv_obj_t * btn) {autons::selected = autons::WAIT ? autons::auto_red_flag_wait : autons::auto_red_flag; return LV_RES_OK;}
  lv_res_t btn_click_action_red_cap(lv_obj_t * btn) {autons::selected = autons::auto_red_cap_park; return LV_RES_OK;}
  lv_res_t btn_click_action_blue_flag(lv_obj_t * btn) {autons::selected = autons::WAIT ? autons::auto_blue_flag_wait : autons::auto_blue_flag; return LV_RES_OK;}
  lv_res_t btn_click_action_blue_cap(lv_obj_t * btn) {autons::selected = autons::auto_blue_cap_park; return LV_RES_OK;}
